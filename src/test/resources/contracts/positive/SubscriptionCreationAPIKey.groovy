...
Contract.make {
  name "correct_subscription_creation_2"
  description "should return CREATED with created entity with generated 'id' in body using X-API-KEY"
  request {
    ...
    headers {
      ...
      header 'X-API-KEY' : anyNonBlankString()
    }
    body(
